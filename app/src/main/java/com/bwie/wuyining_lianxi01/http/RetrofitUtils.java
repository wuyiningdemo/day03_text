...
public class RetrofitUtils {
    ...
    private static RetrofitUtils retrofitUtil = null;
    ...
    public static RetrofitUtils getInstance(String baseUrl) {
        if (retrofitUtil == null) {
            synchronized (RetrofitUtils.class) {
                if (retrofitUtil == null) {
                    retrofitUtil = new RetrofitUtils(baseUrl);
                }
            }
        }
    ...
    public static ApiService getService() {
        return RetrofitUtils.getInstance(Contant.BASE_URL).createService(ApiService.class);
    }
